...
namespace SimpleTaskSystem.Tests
{
    public abstract class SimpleTaskSystemTestBase : AbpIntegratedTestBase
    {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<SimpleTaskSystemTestModule>();
        }
        ...
        protected Task UsingDbContextAsync(Action<SimpleTaskSystemDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Action<SimpleTaskSystemDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<SimpleTaskSystemDbContext>())
